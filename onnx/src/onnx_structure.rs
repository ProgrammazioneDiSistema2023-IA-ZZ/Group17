    ...
    fn dispatch(&mut self, current_structure: &[String], structure_path: &[String], attribute_name: &str, integer_value: i32, float_value: f32, string_value: String, new_structure_to_add: bool) {
        if structure_path.is_empty() { //simple types, direct children of attribute_proto
            match attribute_name {
                ...
                "floats" => panic!("FLOATS RIHIESTO!") /*self.floats.push(float_value)*/,
    ...
    fn dispatch(&mut self, current_structure: &[String], structure_path: &[String], attribute_name: &str, integer_value: i32, float_value: f32, string_value: String, new_structure_to_add: bool) {
        if structure_path.is_empty() { //simple types, direct children of tensor_proto
            match attribute_name {
                ...
                "float_data" => panic!("FLOAT_DATA  NECESSARIO")/*self.float_data.push(float_value)*/,
                "int32_data" => panic!("INT32_DATA NECESSARIO")/*self.int32_data.push(integer_value)*/,
                "string_data" => panic!("STRING_DATA NECESSARIO")/*self.string_data.push(Vec::from(string_value))*/,
                "int64_data" => panic!("INT64_DATA NECESSARIO")/*self.int64_data.push(integer_value.into())*/,
                "name" => self.set_name(string_value),
                "doc_string" => self.set_doc_string(string_value),
                "raw_data" => {
          ...
          while i < self.raw_data.clone().unwrap().len()-3{
            ...
            i+=4;
                ...
                "double_data" => panic!("DOUBLE_DATA NECESSARIO")/*self.double_data.push(float_value.into())*/,
                "uint64_data" => panic!("UINT64_DATA NECESSARIO")/*self.uint64_data.push(integer_value as u64)*/,
...
impl SparseTensorProto {
    ...
    fn dispatch(&mut self, current_structure: &[String], structure_path: &[String], attribute_name: &str, integer_value: i32, float_value: f32, string_value: String, new_structure_to_add: bool) {
        if structure_path.is_empty() { //simple types, direct children of sparse_tensor_proto
            match attribute_name {
                "dims" => panic!("DIMS NECESSARIO")/*self.dims.push(integer_value.into())*/,
                "special_fields" => {}
